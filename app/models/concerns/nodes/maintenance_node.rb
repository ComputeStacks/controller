...
module Nodes
  module MaintenanceNode
    ...
    def offline!
      ...
      NodeWorkers::EvacuateNodeWorker.perform_async global_id
    end
    ...
    def online!
      ...
      NodeWorkers::HealthCheckWorker.perform_async global_id
      NodeWorkers::RecoverVolumeWorker.perform_in 5.minutes, global_id
