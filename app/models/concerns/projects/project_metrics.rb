module Projects
  module ProjectMetrics
    ...
    def current_bandwidth(reset_cache = false)
      cache_key = "d_bw_#{id}"
      Rails.cache.fetch(cache_key, force: reset_cache, expires_in: 30.minutes) do
    ...
    def run_rate(reset_cache = false)
      ...
      Rails.cache.fetch(cache_key, force: reset_cache, expires_in: 1.hour) do
