object @user
attributes :id, :fname, :lname, :email, :phone, :active, :is_admin, :api_key, :api_version, :external_id, :billing_plan_id, :currency, :confirmed_at, :confirmation_sent_at, :last_request_at, :last_sign_in_at, :current_sign_in_at, :sign_in_count, :reset_password_sent_at, :locked_at, :failed_attempts, :address1, :address2, :city, :state, :zip, :country, :vat, :company_name, :created_at, :updated_at
