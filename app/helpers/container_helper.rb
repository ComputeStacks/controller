module ContainerHelper
  ...
  def container_start_path(container)
    %(#{container_path(container)}/power_management/start)
  end

  # @param [Deployment::Container] container
  # @return [String]
  def container_stop_path(container)
    %(#{container_path(container)}/power_management/stop)
  end

  # @param [Deployment::Container] container
  # @return [String]
  def container_restart_path(container)
    %(#{container_path(container)}/power_management/restart)
  end

  # @param [Deployment::Container] container
  # @return [String]
  def container_rebuild_path(container)
    %(#{container_path(container)}/power_management/rebuild)
  end
