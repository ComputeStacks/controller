module DeploymentsHelper
  ...
  def deployment_list_header_icon(deployment)
    ...
    when "working", "deleting"
      icon("fa-solid fa-spin", "rotate", nil, {title: status})
    when "ok"
      icon("fa-solid", "circle-check", nil, {title: "OK"})
    when "unhealthy"
      icon("fa-solid", "triangle-exclamation", nil, {title: "Degraded"})
    else
      icon("fa-solid", "triangle-exclamation", nil, {title: "Alert"})
    end
    badges
  end
