...
class Api::ContainerServices::Metrics::MemoryController < Api::ContainerServices::BaseController
  ##
  # View Container Service Memory Statistics
  #
  # Both the time, and date/memory label and format, will be formatted to match your API user's timezone and locale.
  #
  # `GET /api/container_services/{container-service-id}/metrics/memory`
  #
  ...
  #
  def index
    @stats = @service.metric_mem_usage(3.hours.ago, Time.now, '5m')
    respond_to do |f|
