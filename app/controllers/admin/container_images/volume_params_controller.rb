class Admin::ContainerImages::VolumeParamsController < Admin::ApplicationController
  ...
  def create
    ...
    if @volume.save
      # `check_box` posts a hidden "0" companion, and "0" is truthy in ruby -- cast it.
  ...
  def volume_params
    params.require(:container_image_volume_param).permit(
      ...
      :cascade_changes, :borg_restore_error, borg_pre_backup: [], borg_post_backup: [], borg_pre_restore: [],
