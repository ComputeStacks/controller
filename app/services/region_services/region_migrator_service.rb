  ...
  class RegionMigratorService
    ...
    def halt_containers
      ...
      (region.containers + region.sftp_containers).each do |c|
        ...
        ContainerWorkers::StopWorker.perform_async c.global_id, event.global_id
      end
    ...
    def boot
      ...
      new_region.container_services.each do |s|
        ...
        unless projects.include? s.deployment
          NetworkWorkers::ProjectPolicyWorker.perform_async s.deployment.global_id
      ...
      new_region.containers.each do |c|
        ...
        container_names << c.name unless container_names.include? c.name
        ContainerWorkers::RebuildWorker.perform_async c.global_id, event.global_id
        sleep 2
      end
      event.event_details.create!(
      ...
      projects.each do |p|
        ProjectWorkers::SftpInitWorker.perform_in(5.minutes, p.global_id, event.global_id)
      end
