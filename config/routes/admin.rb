  ...
  namespace :admin do
    ...
    resources :container_images do
      scope module: "container_images" do
        ...
        resources :volume_params do
          scope module: "volume_params" do
            resources :cascade, only: [:create]
          end
        end
        resources :collaborators,
          :env_params,
    ...
    resources :regions do
      scope module: "regions" do
        resources :nodes,
          :network_migrate
        resources :rebuild_networks, only: :create
      end
    end
    ...
    resources :volumes do
      scope module: "volumes" do
        resources :backups, :charts, :clone, :logs, :restore, :subscribers, :exports
      end
    end
