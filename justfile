...
build:
    ...
    docker run -it -d --rm --network "container:cstacks-build-pg" --name cstacks-build-redis --health-cmd "redis-cli ping" --health-interval 10s --health-timeout 5s --health-retries 5 redis:7
