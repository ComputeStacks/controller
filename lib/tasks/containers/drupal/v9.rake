namespace :containers do
  ...
  namespace :drupal do
    desc "Install drupal v9 container"
    task v9: :environment do

      unless ContainerImage.where("labels @> ?", { system_image_name: "drupal-9" }.to_json).exists?
