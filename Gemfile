...
gem 'tzinfo-data', '= 1.2022.2' # No source of timezone data could be found. (TZInfo::DataSourceNotFound)

gem 'rake', '= 13.0.6'
gem 'sprockets', '= 4.1.1'
gem 'sprockets-rails', '= 3.4.2'
gem 'webpacker', '= 5.4.3'
gem 'pg', '= 1.4.3', platform: :ruby
gem 'jquery-rails', '= 4.3.5'

gem 'httparty', '= 0.20.0' # @deprecated for httprb
gem 'http', '= 5.1.0' # v5+ has breaking changes
...
# gem 'c_s_image_mariadb', path: 'plugins/c_s_image_mariadb'
