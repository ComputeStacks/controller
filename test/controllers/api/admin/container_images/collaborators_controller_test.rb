...
class Api::Admin::ContainerImages::CollaboratorsControllerTest < ActionDispatch::IntegrationTest
  ...
  def before_setup
    ...
    @collab.save
    @collab_base_path = "/api/admin/container_images/#{@item.id}/collaborators"
  end
